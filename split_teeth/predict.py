...
def parse_args():
    ...
    # 添加数据路径参数
    parser.add_argument("--data_path", default="C:\\users\\wwg\\Pictures\\Screenshots\\屏幕截图 2026-03-25 225154.png",
                        help="data root")
    # 添加模型权重路径参数
    parser.add_argument("--weights", default="run/train/exp10/weights/best_model_1.pth")
    # 添加类别数量参数，默认为 3
